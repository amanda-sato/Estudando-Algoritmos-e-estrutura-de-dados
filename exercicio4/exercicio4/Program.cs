...
namespace exercicio4
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //ctrl + H substitui vários de uma vez.
            ...
            veiculos.Inserir(new Veiculo { Matricula = "AA-11-21", AnoConstrucao = 2010, Cor = "preto", Estado = false, NifProprietario = "556"});
            veiculos.Inserir(new Veiculo { Matricula = "BB-22-33", AnoConstrucao = 2021, Cor = "vermelho", Estado = true, NifProprietario = "556"});
            veiculos.Inserir(new Veiculo { Matricula = "AA-11-22", AnoConstrucao = 2010, Cor = "branco", Estado = true, NifProprietario = "111"});
            veiculos.Inserir(new Veiculo { Matricula = "AA-11-29", AnoConstrucao = 2012, Cor = "branco", Estado = true, NifProprietario = "111" });
            veiculos.Inserir(new Veiculo { Matricula = "AA-25-29", AnoConstrucao = 1952, Cor = "amarelo", Estado = false, NifProprietario = "111" });


            acidentes.Inserir(new Acidente { Ano = 2011, Matricula = "AA-11-21", NumeroAcidentes = 2 });
            acidentes.Inserir(new Acidente { Ano = 2023, Matricula = "BB-22-33", NumeroAcidentes = 1 });
            acidentes.Inserir(new Acidente { Ano = 2018, Matricula = "AA-11-21", NumeroAcidentes = 1 });
            acidentes.Inserir(new Acidente { Ano = 2009, Matricula = "AA-25-29", NumeroAcidentes = 2 });
            acidentes.Inserir(new Acidente { Ano = 2018, Matricula = "AA-25-29", NumeroAcidentes = 5 });
        ...
        public static Proprietario[] ProprietarioListaOrdemInversa(IConjunto<Proprietario> proprietarios)
        {
            ...
            proprietarios.ReverterOrdem();
            Proprietario[] lista = proprietarios.ReverterOrdem();
            foreach (Proprietario p in lista)
            {
                Console.WriteLine(p);
            }
